...
// É uma anotação do JPA, para demonstrar que é uma entidade(tabela) que será
...
public class Emprestimo {
    ...
    @Id  //Obrigatório
    @GeneratedValue(strategy = GenerationType.IDENTITY) //Nâo é obrigatório mas 99% é utilizado
    private Long id;
